defmodule PhoenixReactStarter.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import PhoenixReactStarter.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&PhoenixReactStarter.ErrorHelpers.translate_error/1)
